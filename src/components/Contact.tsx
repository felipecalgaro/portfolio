...
export function Contact() {
  return (
    <div className='flex flex-col justify-center items-center gap-10 w-full' id='contact'>
      ...
      <p className='text-center'>Please contact me directly at <a href='mailto:fcalgaro.contact@gmail.com' className='underline'>fcalgaro.contact@gmail.com</a> or through this form.</p>
      <ContactForm />
    </div>
  )
}