...
export function Navbar() {
  ...
  return (
    <div className='sm:flex hidden justify-center items-center lg:gap-14 gap-4 rounded-sm lg:text-xl text-lg text-[#484848] shadow-2xl py-4 sticky top-8 z-20 bg-white lg:w-[800px] w-[500px]'>
      {sectionIds.map(id => (
